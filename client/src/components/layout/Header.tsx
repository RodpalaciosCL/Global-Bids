  ...
  useEffect(() => {
    ...
    const updateHeaderHeight = () => {
      ...
      if (header) {
        ...
        document.documentElement.style.setProperty('--header-height', `${height + 40}px`);
      }
    };
        ...
        <div className="flex justify-between items-center">
          ...
          <a href="/#inicio">
            ...
            >
              ...
              <div>
                <div className="font-heading font-bold text-xl sm:text-xl md:text-2xl text-white tracking-tight">Global Bids</div>
                <div className="text-xs text-white/90 font-medium hidden sm:block">
                  {t('nav.logoTagline')}
                </div>
              </div>
            </motion.div>
