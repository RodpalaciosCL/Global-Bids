...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'about.model360Desc': 'Nuestro proceso integral garantiza eficiencia y transparencia en cada etapa, desde la evaluación hasta la entrega final',
    'about.phase1': 'Fase 1: Preparación',
    'about.phase2': 'Fase 2: Transacción',
    'about.phase3': 'Fase 3: Logística',
    'about.assets': 'Activos a rematar',
    'about.assetsDesc': 'Evaluación detallada de cada activo para garantizar su valor',
    'about.material': 'Material gráfico en terreno',
    'about.materialDesc': 'Fotografías profesionales y videos 4K que muestran el estado real',
    'about.platform': 'Plataforma',
    'about.platformDesc': 'Publicación en nuestra plataforma digital con detalles técnicos completos',
    'about.marketing': 'Marketing',
    'about.marketingDesc': 'Difusión estratégica a nuestra base de más de 950,000 clientes globales',
    'about.clients950k': '950k clientes globales',
    'about.event': 'Evento Remate',
    'about.eventDesc': 'Presencial y online',
    'about.eventFullDesc': 'Realización del evento con participación presencial y virtual simultánea',
    'about.buyerPays': 'Comprador paga el lote adjudicado',
    'about.buyerPaysDesc': 'Proceso de pago seguro para el comprador con múltiples opciones',
    'about.payment': 'Pago a consignatario',
    'about.paymentDesc': 'Transferencia rápida y segura de fondos al consignatario del activo',
    'about.certificate': 'Certificado de pago para liberar carga',
    'about.certificateDesc': 'Emisión de documentación certificada para autorizar el retiro del activo',
    'about.logistics': 'Logística de retiro y despacho',
    'about.logisticsDesc': 'Coordinación de transporte especializado nacional e internacional',
    'about.delivery': 'Entrega en destino',
    'about.deliveryDesc': 'Entrega verificada en la ubicación designada por el comprador',
  ...
  en: {
    ...
    'about.model360Desc': 'Our comprehensive process ensures efficiency and transparency at every stage, from evaluation to final delivery',
    'about.phase1': 'Phase 1: Preparation',
    'about.phase2': 'Phase 2: Transaction',
    'about.phase3': 'Phase 3: Logistics',
    'about.assets': 'Assets for auction',
    'about.assetsDesc': 'Detailed evaluation of each asset to guarantee its value',
    'about.material': 'Field graphic material',
    'about.materialDesc': 'Professional photographs and 4K videos showing the actual condition',
    'about.platform': 'Platform',
    'about.platformDesc': 'Publication on our digital platform with complete technical details',
    'about.marketing': 'Marketing',
    'about.marketingDesc': 'Strategic distribution to our database of over 950,000 global clients',
    'about.clients950k': '950k global clients',
    'about.event': 'Auction Event',
    'about.eventDesc': 'In-person and online',
    'about.eventFullDesc': 'Event execution with simultaneous in-person and virtual participation',
    'about.buyerPays': 'Buyer pays for awarded lot',
    'about.buyerPaysDesc': 'Secure payment process for the buyer with multiple options',
    'about.payment': 'Payment to consignor',
    'about.paymentDesc': 'Fast and secure transfer of funds to the asset consignor',
    'about.certificate': 'Payment certificate to release cargo',
    'about.certificateDesc': 'Issuance of certified documentation to authorize asset withdrawal',
    'about.logistics': 'Pickup and shipping logistics',
    'about.logisticsDesc': 'Coordination of specialized national and international transport',
    'about.delivery': 'Delivery at destination',
    'about.deliveryDesc': 'Verified delivery at the location designated by the buyer',
    'about.worldPresence': 'Chile - USA - Worldwide',
